...
public class DrugClassDef {
	...
	public static SimpleMemoizer<GraphQLObjectType> oDrugClass = new SimpleMemoizer<>(
		name -> (
			...
			.field(field -> newMutationSet(name, field, "drugResistMutations", /* enableIncludedGenes= */false)
				.description("All drug resistance mutations (DRMs) of this drug class."))
			.field(field -> newMutationSet(name, field, "surveilDrugResistMutations", /* enableIncludedGenes= */false)
				.description("All surveillance drug resistance mutations (SDRMs) of this drug class."))
			.field(field -> newMutationSet(name, field, "rxSelectedMutations", /* enableIncludedGenes= */false)
